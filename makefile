...
build: deps
	...
	@echo
	@echo Building coredns for linux-amd64...
	@cd cmd/coredns/ && env CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -v -o ../../dist/coredns-linux-amd64

	@echo
	@echo Building coredns for linux-arm...
	@cd cmd/coredns/ && env CGO_ENABLED=0 GOOS=linux GOARCH=arm go build -v -o ../../dist/coredns-linux-arm
...
ifeq (${COMMIT_HASH}, ${TAG})
	...
	@docker build -f dockerfile --build-arg NAME=coredns-linux-amd64 -t ${DOCKER_URL}/${OWNER}/${NAME}/${NAME}-dev:${COMMIT_HASH} dist

	@echo Building container ${DOCKER_URL}/${OWNER}/${NAME}/${NAME}-arm-dev:${COMMIT_HASH}
	@docker build -f dockerfile --build-arg NAME=coredns-linux-arm -t ${DOCKER_URL}/${OWNER}/${NAME}/${NAME}-arm-dev:${COMMIT_HASH} dist
	...
	@docker build -f dockerfile --build-arg NAME=coredns-linux-amd64 -t ${DOCKER_URL}/${OWNER}/${NAME}/${NAME}-dev:${TAG} dist

	@echo Building container ${DOCKER_URL}/${OWNER}/${NAME}/${NAME}-arm-dev:${TAG}
	@docker build -f dockerfile --build-arg NAME=coredns-linux-arm -t ${DOCKER_URL}/${OWNER}/${NAME}/${NAME}-arm-dev:${TAG} dist
	...
	@docker build -f dockerfile --build-arg NAME=coredns-linux-amd64 -t ${DOCKER_URL}/${OWNER}/${NAME}/${NAME}:${TAG} dist

	@echo Building container ${DOCKER_URL}/${OWNER}/${NAME}/${NAME}-arm:${TAG}
	@docker build -f dockerfile --build-arg NAME=coredns-linux-arm -t ${DOCKER_URL}/${OWNER}/${NAME}/${NAME}-arm:${TAG} dist
endif
